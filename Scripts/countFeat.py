...
def main(corpusFolderDir):
    countInvariants("../subjectivity/resources/other_features", corpusFolderDir, "../subjectivity/results/other_counts")
    countInvariants("../subjectivity/resources/socal_features/socal_invariant", corpusFolderDir, "../subjectivity/results/socal_counts/invariant")
    countVariants("../subjectivity/resources/socal_features/socal_variant", corpusFolderDir, "../subjectivity/results/socal_counts/variant")
